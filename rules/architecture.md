...
- **Separate concerns into layers** — always split route handlers, business logic, and data access into distinct layers (e.g. `routes/`, `service/`, `repository/`), regardless of current size.
