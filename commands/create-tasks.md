...
8. Create a dedicated test task that use rule testing.md — save it as the last task file before documentation (e.g. `05-tests.md`) - TODO: USE THE TEST SKILL FOR THIS 
